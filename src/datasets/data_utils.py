...
from src.datasets.collate import collate_fn_vocoder as collate_fn
...
def get_dataloaders(config, device):
    ...
    mel_transform = transforms["instance_transforms"]

    datasets = {}
    for split_name, split_cfg in config.datasets.items():
        datasets[split_name] = instantiate(
            split_cfg,
